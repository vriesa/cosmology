...
\newcommand{\titel}{Cosmology: Principles and Current Trends}
\newcommand{\untertitel}{}
%===============================================================
%%% Seiteneinstellungen: %%%%%%
\usepackage[paper=a4paper,inner=30mm,outer=30mm,top=20mm,bottom=20mm]{geometry}
%-------------------------------------------------
...
\input{general-relativity}
\input{FLRW-models}
\input{conformal-geometry}
