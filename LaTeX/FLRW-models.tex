...
\caption{\label{fig:Friedmann-Kosmen}
	Expansions of the three FLRW cosmologies with $\Lambda=0$. The reciprocal of the Hubble constant $H_0$ represents an upper limit for the age of the universe, as can be seen from the tangent equation $h(t) = \dot{R}(t_0) (t-t_0) + R(t_0)$.}
\end{figure}
%--- Figure ----------------------------------------------------------
...
The present-day density $\rho_{0}$, which according to the current state of knowledge suggest to give zero curvature $k$. Substituting these conditions to the Friedmann equation gives
\begin{equation}
	\rho_{\mathrm{crit}}
	=
	\frac{3H_{0}^{2}}{8\pi G}
